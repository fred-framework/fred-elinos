...
../../dag -s zcu102-mat64-128-hf --solve -max-threads --create-bounds -pb 3.12163670270603 -osol $PROB.sol -olp $PROB.lp -odot $PROB.dot -oyaml $PROB.yaml -oyml ${PROB}_input.yaml \
